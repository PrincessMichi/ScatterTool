...
class ScatterToolUI(QtWidgets.QDialog):
    ...
    def create_connections(self):
        ...
        self.rand_scatter_btn.clicked.connect(self._random_scatter)
    ...
    def _create_button_ui(self):
        ...
        self.rand_scatter_btn = QtWidgets.QPushButton("Randomize Values")
        layout = QtWidgets.QHBoxLayout()
        layout.addWidget(self.scatter_btn)
        layout.addWidget(self.rand_scatter_btn)
        return layout
    ...
    def scatter_fx(self):
        ...
        if cmds.objectType(object_to_instance) == 'transform':
            for vertex in vertex_names:
                ...
                new_uniform_scale = random.uniform(self.set_scatter.scale_min, self.set_scatter.scale_max)
                ...
                # new_density = int(len(vertex) * self.dens_sbx / 100)
                # cmds.move(new_density,
                          # new_density,
                          # new_density,
                          # new_instance,
                          # relative=True,
    ...
    def randomize_values(self):
        self.set_scatter.scale_max = random.uniform(0.0, 1.0)
        self.set_scatter.scale_min = random.uniform(0.0, 1.0)
        self.set_scatter.rot_x_min = random.uniform(0, 360)
        self.set_scatter.rot_y_min = random.uniform(0, 360)
        self.set_scatter.rot_z_min = random.uniform(0, 360)
        self.set_scatter.rot_x_max = random.uniform(0, 360)
        self.set_scatter.rot_y_max = random.uniform(0, 360)
        self.set_scatter.rot_z_max = random.uniform(0, 360)
